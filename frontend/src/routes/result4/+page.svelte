<script context="module">
  ...
  export async function load({ page }) {
    ...
    const ABL1_LikeaverageResult = page.query.ABL1_LikeaverageResult || null;
    const ABL1selected = page.query.ABL1selected || null;
    const CRLF2selected = page.query.CRLF2selected || null;
    const ABL1_LikeSelected = page.query.ABL1_LikeSelected || null;
